// Simple Express server for handling email sending and chat functionality
// This server provides an API endpoint for sending emails from the contact form and handling chat requests
